...
// checkout.php - Checkout and delivery details page
    ...
    if (empty($streetAddress) || empty($city) || empty($postalCode)) {
        ...
        foreach ($cartItems as $item) {
            ...
            $sql = "INSERT INTO tblAorder 
                    (userID, clothesID, totalAmount, addressType, 
                     streetAddress, city, province, postalCode)
                    VALUES 
                    ($userID, $clothesID, $price, '$addressType',
                     '$streetAddress', '$city', '$province', '$postalCode')";
            $conn->query($sql);

            // Update item status to sold
            $conn->query("UPDATE tblClothes SET status='sold' 
...
<div class="container">
    ...
    <?php if ($success): ?>
        ...
        <div style="text-align:center; padding:60px 20px;">
            <h2 style="font-size:28px; margin-bottom:15px;">Order Confirmed! </h2>
            <p style="color:#666; font-size:16px; margin-bottom:10px;">
                Thank you for your order, 
                <?php echo htmlspecialchars($_SESSION['firstName']); ?>!
            </p>
            <p style="color:#666; font-size:16px; margin-bottom:30px;">
                Your items will be delivered to your provided address soon.
            </p>
            <a href="listings.php">
    ...
    <?php else: ?>
        ...
        <!-- ORDER SUMMARY -->
        <h3 style="margin:20px 0 10px; font-size:16px; 
        ...
        <table class="data-table" style="margin-bottom:30px;">
            ...
            <tr>
                <td colspan="2" style="text-align:right; 
                    font-weight:600; padding:15px;">TOTAL:</td>
                <td style="font-weight:bold; font-size:18px; padding:15px;">
                    ...
                    <div style="display:flex; gap:30px; margin-top:8px;">
                        <label style="display:flex; align-items:center; 
                            ...
                            <input type="radio" name="addressType" 
                                   value="residential" required checked>
                            Residential
                        </label>
                        <label style="display:flex; align-items:center; 
                               gap:8px; font-weight:normal; 
